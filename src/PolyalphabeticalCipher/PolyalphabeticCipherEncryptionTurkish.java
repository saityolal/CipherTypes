...
public class PolyalphabeticCipherEncryptionTurkish {
    public static void main(String[] args) {


        char[] alphabet = {'a', 'b', 'c', 'ç', 'd', 'e', 'f', 'g', 'ğ', 'h', 'ı', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'ö', 'p', 'q', 'r',
                's', 'ş', 't', 'u', 'ü', 'v', 'y', 'z'};

        try {
            FileOutputStream fos = new FileOutputStream("C:/Users/sado/Desktop/software optimization/software optimization/Alice Message With PolyAlphabeticCipher Encrypted Turkish.txt", false);
            PrintStream ps = new PrintStream(fos, true, StandardCharsets.UTF_8);

            FileOutputStream fos_key = new FileOutputStream("C:/Users/sado/Desktop/software optimization/software optimization/PolyAlphabeticCipher Key Turkish.txt", false);
            PrintStream ps_key = new PrintStream(fos_key, true, StandardCharsets.UTF_8);

            FileInputStream fis = new FileInputStream("C:/Users/sado/Desktop/software optimization/software optimization/Alice Message Turkish.txt");
            ...
            while ((i = br.read()) >= 0) {
                ...
                if (Character.isLetter(c)) {
                    text.append(c);
                    char x = alphabet[random.nextInt(alphabet.length)];
                    key.append(x);
                } else {
                    text.append(" ");
                    key.append(" ");
